...
const DOSOPTF_DEFAULT     = 1;
const DOSOPTF_SUPPORTED   = 2;
const DOSOPTF_ALWAYSUSE   = 4;
const DOSOPTF_USESPMODE   = 8;
const DOSOPTF_PROVIDESUMB = 16;
const DOSOPTF_NEEDSETUP   = 32;
const DOSOPTF_INDOSSTART  = 64;
const DOSOPTF_MULTIPLE    = 128;

const SUF_FIRSTTIME  = 1;
const SUF_EXPRESS    = 2;
const SUF_BATCHINF   = 4;
const SUF_CLEAN      = 8;
const SUF_INSETUP    = 16;
const SUF_NETSETUP   = 32;
const SUF_NETHDBOOT  = 64;
const SUF_NETRPLBOOT = 128;
const SUF_SBSCOPYOK  = 256;
...
const PCMCIA_OPT_HAVE_SOCKET  = 1;
const PCMCIA_OPT_AUTOMEM      = 4;
const PCMCIA_OPT_NO_SOUND     = 8;
const PCMCIA_OPT_NO_AUDIO     = 16;
const PCMCIA_OPT_NO_APMREMOVE = 32;
...
const PCI_FLAG_NO_VIDEO_IRQ      = 1;
const PCI_FLAG_PCMCIA_WANT_IRQ   = 2;
const PCI_FLAG_DUAL_IDE          = 4;
const PCI_FLAG_NO_ENUM_AT_ALL    = 8;
const PCI_FLAG_ENUM_NO_RESOURCE  = 16;
const PCI_FLAG_NEED_DWORD_ACCESS = 32;
const PCI_FLAG_SINGLE_FUNCTION   = 64;
const PCI_FLAG_ALWAYS_ENABLED    = 128;
const PCI_FLAG_IS_IDE            = 256;
const PCI_FLAG_IS_VIDEO          = 512;
const PCI_FLAG_FAIL_START        = 1024;

const REGSTR_VAL_MAX_HCID_LEN = 1024;

const REGDF_NOTDETIO        = 1;
const REGDF_NOTDETMEM       = 2;
const REGDF_NOTDETIRQ       = 4;
const REGDF_NOTDETDMA       = 8;
const REGDF_NOTDETALL       = REGDF_NOTDETIO | REGDF_NOTDETMEM | REGDF_NOTDETIRQ | REGDF_NOTDETDMA;
const REGDF_NEEDFULLCONFIG  = 16;
const REGDF_GENFORCEDCONFIG = 32;
...
const CONFIGFLAG_DISABLED       = 1;
const CONFIGFLAG_REMOVED        = 2;
const CONFIGFLAG_MANUAL_INSTALL = 4;
const CONFIGFLAG_IGNORE_BOOT_LC = 8;
const CONFIGFLAG_NET_BOOT       = 16;
const CONFIGFLAG_REINSTALL      = 32;
const CONFIGFLAG_FAILEDINSTALL  = 64;
const CONFIGFLAG_CANTSTOPACHILD = 128;
const CONFIGFLAG_OKREMOVEROM    = 256;
const CONFIGFLAG_NOREMOVEEXIT   = 512;
