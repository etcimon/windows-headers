...
alias PALETTENTRY *PPALETTEENTRY;
...
alias BLENDFUNCTION *LPBLENDFUNCTION;
...
/+ TODO:
alias BOOL (CALLBACK *ABORTPROC)(HDC,int);
alias int (CALLBACK *MFENUMPROC)(HDC,HANDLETABLE*,METARECORD*,int,LPARAM);
alias int (CALLBACK *ENHMFENUMPROC)(HDC,HANDLETABLE*,ENHMETARECORD*,int,LPARAM);
alias int (CALLBACK *OLDFONTENUMPROCA)( LOGFONTA*, TEXTMETRICA*,DWORD,LPARAM);
alias int (CALLBACK *OLDFONTENUMPROCW)( LOGFONTW*, TEXTMETRICW*,DWORD,LPARAM);
alias OLDFONTENUMPROCA FONTENUMPROCA;
alias OLDFONTENUMPROCW FONTENUMPROCW;
alias int (CALLBACK *ICMENUMPROCA)(LPSTR,LPARAM);
alias int (CALLBACK *ICMENUMPROCW)(LPWSTR,LPARAM);
alias void (CALLBACK *GOBJENUMPROC)(LPVOID,LPARAM);
alias void (CALLBACK *LINEDDAPROC)(int,int,LPARAM);
alias UINT (CALLBACK *LPFNDEVMODE)(HWND,HMODULE,LPDEVMODEA,LPSTR,LPSTR,LPDEVMODEA,LPSTR,UINT);
alias DWORD (CALLBACK *LPFNDEVCAPS)(LPSTR,LPSTR,UINT,LPSTR,LPDEVMODEA);
+/
