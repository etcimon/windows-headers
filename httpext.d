...
alias _HSE_VERSION_INFO HSE_VERSION_INFO;
alias _HSE_VERSION_INFO* LPHSE_VERSION_INFO;
...
struct _EXTENSION_CONTROL_BLOCK	{
	...
	extern(Pascal) BOOL function(HCONN, LPSTR, LPVOID, LPDWORD) GetServerVariable;
	...
	extern(Pascal) BOOL function(HCONN, DWORD, LPVOID, LPDWORD, LPDWORD) ServerSupportFunction;
}
alias _EXTENSION_CONTROL_BLOCK EXTENSION_CONTROL_BLOCK;
alias _EXTENSION_CONTROL_BLOCK* LPEXTENSION_CONTROL_BLOCK;
...
alias _HSE_TF_INFO HSE_TF_INFO;
alias _HSE_TF_INFO* LPHSE_TF_INFO;
...
alias _HSE_SEND_HEADER_EX_INFO HSE_SEND_HEADER_EX_INFO;
alias _HSE_SEND_HEADER_EX_INFO* LPHSE_SEND_HEADER_EX_INF;
