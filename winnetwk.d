...
version (Unicode) {
	...
	alias NETRESOURCEW* LPNETRESOURCE;
	alias CONNECTDLGSTRUCTW CONNECTDLGSTRUCT;
	alias CONNECTDLGSTRUCTW* LPCONNECTDLGSTRUCT;
	alias DISCDLGSTRUCTW DISCDLGSTRUCT;
	alias DISCDLGSTRUCTW* LPDISCDLGSTRUCT;
	alias REMOTE_NAME_INFOW REMOTE_NAME_INFO;
	alias REMOTE_NAME_INFOW* LPREMOTE_NAME_INFO;
	alias UNIVERSAL_NAME_INFOW UNIVERSAL_NAME_INFO;
	alias UNIVERSAL_NAME_INFOW* LPUNIVERSAL_NAME_INFO;
	...
	alias NETRESOURCEA* LPNETRESOURCE;
	alias CONNECTDLGSTRUCTA CONNECTDLGSTRUCT;
	alias CONNECTDLGSTRUCTA* LPCONNECTDLGSTRUCT;
	alias DISCDLGSTRUCTA DISCDLGSTRUCT;
	alias DISCDLGSTRUCTA* LPDISCDLGSTRUCT;
	alias REMOTE_NAME_INFOA REMOTE_NAME_INFO;
	alias REMOTE_NAME_INFOA* LPREMOTE_NAME_INFO;
	alias UNIVERSAL_NAME_INFOA UNIVERSAL_NAME_INFO;
	alias UNIVERSAL_NAME_INFOA* LPUNIVERSAL_NAME_INFO;
