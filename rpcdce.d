...
const RPC_C_SECURITY_QOS_VERSION=L;
...
extern (Windows) {
RPC_STATUS RpcBindingFromStringBindingA(ubyte *,RPC_BINDING_HANDLE *);
RPC_STATUS RpcBindingFromStringBindingW(ushort *,RPC_BINDING_HANDLE *);
RPC_STATUS RpcBindingToStringBindingA(RPC_BINDING_HANDLE,ubyte**);
RPC_STATUS RpcBindingToStringBindingW(RPC_BINDING_HANDLE,ushort**);
...
RPC_STATUS RpcServerUseProtseqExA(ubyte*,uint MaxCalls,void*,PRPC_POLICY);
RPC_STATUS RpcServerUseProtseqExW(ushort*,uint,void*,PRPC_POLICY);
RPC_STATUS RpcServerUseProtseqEpA(ubyte*,uint,ubyte*,void*);
RPC_STATUS RpcServerUseProtseqEpExA(ubyte*,uint,ubyte*,void*,PRPC_POLICY);
RPC_STATUS RpcServerUseProtseqEpW(ushort*,uint,ushort*,void*);
RPC_STATUS RpcServerUseProtseqEpExW(ushort*,uint,ushort*,void*,PRPC_POLICY);
RPC_STATUS RpcServerUseProtseqIfA(ubyte*,uint,RPC_IF_HANDLE,void*);
RPC_STATUS RpcServerUseProtseqIfExA(ubyte*,uint,RPC_IF_HANDLE,void*,PRPC_POLICY);
RPC_STATUS RpcServerUseProtseqIfW(ushort*,uint,RPC_IF_HANDLE,void*);
RPC_STATUS RpcServerUseProtseqIfExW(ushort*,uint,RPC_IF_HANDLE,void*,PRPC_POLICY);
RPC_STATUS RpcMgmtInqServerPrincNameA(RPC_BINDING_HANDLE,uint,ubyte**);
RPC_STATUS RpcMgmtInqServerPrincNameW(RPC_BINDING_HANDLE,uint,ushort**);
RPC_STATUS RpcServerInqDefaultPrincNameA(uint,ubyte**);
RPC_STATUS RpcServerInqDefaultPrincNameW(uint,ushort**);
RPC_STATUS RpcNsBindingInqEntryNameA(RPC_BINDING_HANDLE,uint,ubyte**);
RPC_STATUS RpcNsBindingInqEntryNameW(RPC_BINDING_HANDLE,uint,ushort**);
RPC_STATUS RpcBindingInqAuthClientA(RPC_BINDING_HANDLE,RPC_AUTHZ_HANDLE *,ubyte**,uint*,uint*,uint*);
RPC_STATUS RpcBindingInqAuthClientW(RPC_BINDING_HANDLE,RPC_AUTHZ_HANDLE *,ushort**,uint*,uint*,uint*);
RPC_STATUS RpcBindingInqAuthInfoA(RPC_BINDING_HANDLE,ubyte**,uint*,uint*,RPC_AUTH_IDENTITY_HANDLE*,uint*);
RPC_STATUS RpcBindingInqAuthInfoW(RPC_BINDING_HANDLE,ushort**,uint*,uint*,RPC_AUTH_IDENTITY_HANDLE*,uint*);
RPC_STATUS RpcBindingSetAuthInfoA(RPC_BINDING_HANDLE,ubyte*,uint,uint,RPC_AUTH_IDENTITY_HANDLE,uint);
RPC_STATUS RpcBindingSetAuthInfoExA(RPC_BINDING_HANDLE,ubyte*,uint,uint,RPC_AUTH_IDENTITY_HANDLE,uint,RPC_SECURITY_QOS*);
RPC_STATUS RpcBindingSetAuthInfoW(RPC_BINDING_HANDLE,ushort*,uint,uint,RPC_AUTH_IDENTITY_HANDLE,uint);
RPC_STATUS RpcBindingSetAuthInfoExW(RPC_BINDING_HANDLE,ushort*,uint,uint,RPC_AUTH_IDENTITY_HANDLE,uint,RPC_SECURITY_QOS*);
RPC_STATUS RpcBindingInqAuthInfoExA(RPC_BINDING_HANDLE,ubyte**,uint*,uint*,RPC_AUTH_IDENTITY_HANDLE*,uint*,uint,RPC_SECURITY_QOS*);
RPC_STATUS RpcBindingInqAuthInfoExW(RPC_BINDING_HANDLE,ushort ** , uint *, uint *, RPC_AUTH_IDENTITY_HANDLE *, uint *, uint , RPC_SECURITY_QOS *);
alias void function(void*,ushort*,uint,void**,RPC_STATUS*) RPC_AUTH_KEY_RETRIEVAL_FN;
...
RPC_STATUS UuidToStringA(UUID*,ubyte**);
RPC_STATUS UuidFromStringA(ubyte*,UUID*);
RPC_STATUS UuidToStringW(UUID*,ushort**);
RPC_STATUS UuidFromStringW(ushort*,UUID*);
RPC_STATUS RpcEpRegisterNoReplaceA(RPC_IF_HANDLE,RPC_BINDING_VECTOR*,UUID_VECTOR*,ubyte*);
RPC_STATUS RpcEpRegisterNoReplaceW(RPC_IF_HANDLE,RPC_BINDING_VECTOR*, UUID_VECTOR*,ushort*);
RPC_STATUS RpcEpRegisterA(RPC_IF_HANDLE,RPC_BINDING_VECTOR*,UUID_VECTOR*,ubyte*);
RPC_STATUS RpcEpRegisterW(RPC_IF_HANDLE,RPC_BINDING_VECTOR*,UUID_VECTOR*,ushort*);
RPC_STATUS DceErrorInqTextA(RPC_STATUS,ubyte*);
RPC_STATUS DceErrorInqTextW(RPC_STATUS,ushort*);
RPC_STATUS RpcMgmtEpEltInqNextA(RPC_EP_INQ_HANDLE,RPC_IF_ID*,RPC_BINDING_HANDLE*,UUID*,ubyte**);
RPC_STATUS RpcMgmtEpEltInqNextW(RPC_EP_INQ_HANDLE,RPC_IF_ID*,RPC_BINDING_HANDLE*,UUID*,ushort**);
}
...
RPC_STATUS RpcBindingFromStringBinding(ubyte *,RPC_BINDING_HANDLE *);
RPC_STATUS RpcBindingToStringBinding(RPC_BINDING_HANDLE,ubyte **);
RPC_STATUS RpcStringBindingCompose(ubyte *,ubyte *,ubyte *,ubyte *,ubyte *,ubyte **);
RPC_STATUS RpcStringBindingParse(ubyte *,ubyte **,ubyte **,ubyte **,ubyte **,ubyte **);
RPC_STATUS RpcStringFree(ubyte**);
RPC_STATUS RpcNetworkIsProtseqValid(ubyte*);
RPC_STATUS RpcNetworkInqProtseqs(RPC_PROTSEQ_VECTOR **);
RPC_STATUS RpcServerInqBindings(RPC_BINDING_VECTOR **);
RPC_STATUS RpcServerUseProtseq(ubyte*,uint,void*);
RPC_STATUS RpcServerUseProtseqEx(ubyte*,uint,void*,PRPC_POLICY);
RPC_STATUS RpcServerUseProtseqEp(ubyte*,uint,ubyte*,void*);
RPC_STATUS RpcServerUseProtseqEpEx(ubyte*,uint,ubyte*,void*,PRPC_POLICY);
RPC_STATUS RpcServerUseProtseqIf(ubyte*,uint,RPC_IF_HANDLE,void*);
RPC_STATUS RpcServerUseProtseqIfEx(ubyte*,uint,RPC_IF_HANDLE,void*,PRPC_POLICY);
RPC_STATUS RpcMgmtInqServerPrincName(RPC_BINDING_HANDLE,uint,ubyte**);
RPC_STATUS RpcServerInqDefaultPrincName(uint,ubyte**);
RPC_STATUS RpcNsBindingInqEntryName(RPC_BINDING_HANDLE,uint,ubyte**);
RPC_STATUS RpcBindingInqAuthClient(RPC_BINDING_HANDLE,RPC_AUTHZ_HANDLE*,ubyte**,uint*,uint*,uint*);
RPC_STATUS RpcBindingInqAuthInfo(RPC_BINDING_HANDLE,ubyte **,uint *,uint *,RPC_AUTH_IDENTITY_HANDLE *,uint *);
RPC_STATUS RpcBindingSetAuthInfo(RPC_BINDING_HANDLE,ubyte *,uint,uint,RPC_AUTH_IDENTITY_HANDLE,uint);
alias void function(void*,ubyte*,uint,void**,RPC_STATUS*) RPC_AUTH_KEY_RETRIEVAL_FN;
RPC_STATUS RpcServerRegisterAuthInfo(ubyte*,uint,RPC_AUTH_KEY_RETRIEVAL_FN,void*);
RPC_STATUS UuidToString(UUID*,ubyte**);
RPC_STATUS UuidFromString(ubyte*,UUID*);
RPC_STATUS RpcEpRegisterNoReplace(RPC_IF_HANDLE,RPC_BINDING_VECTOR*,UUID_VECTOR*,ubyte*);
RPC_STATUS RpcEpRegister(RPC_IF_HANDLE,RPC_BINDING_VECTOR*,UUID_VECTOR*,ubyte*);
RPC_STATUS DceErrorInqText(RPC_STATUS,ubyte*);
RPC_STATUS RpcMgmtEpEltInqNext(RPC_EP_INQ_HANDLE,RPC_IF_ID *,RPC_BINDING_HANDLE *,ubyte **);
