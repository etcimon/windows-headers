...
const CFM_SUBSCRIPT=0x00030000;
const CFM_SUPERSCRIPT=0x00030000;
const CFE_BOLD=1;
const CFE_ITALIC=2;
...
const IMF_FORCENONE=1;
const IMF_FORCEENABLE=2;
const IMF_FORCEDISABLE=4;
const IMF_CLOSESTATUSWINDOW=8;
const IMF_VERTICAL=32;
const IMF_FORCEACTIVE=64;
const IMF_FORCEINACTIVE=128;
const IMF_FORCEREMEMBER=256;
