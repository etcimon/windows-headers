...
private import windows.w32api, windows.winbase, windows.wingdi;
private import windows.windef; // for HMONITOR
...
static if (_WIN32_WINNT >= 0x410) {
	...
	version(LDC){}else BOOL GetMonitorInfoA(HMONITOR, LPMONITORINFOEXA);
	BOOL GetMonitorInfoW(HMONITOR, LPMONITORINFO);
	version(LDC){}else BOOL GetMonitorInfoW(HMONITOR, LPMONITORINFOEXW);
