...
extern (Windows) {
	...
	version(LDC){}else	OLESTATUS OleSaveToStream(LPOLEOBJECT, LPOLESTREAM);
	...
	version(LDC){}else	OLESTATUS OleDraw(LPOLEOBJECT, HDC, LPCRECT, LPCRECT, HDC);
	...
	OLESTATUS OleCreateLinkFromClip(LPCSTR, LPOLECLIENT, LHCLIENTDOC, LPCSTR,
	  LPOLEOBJECT*, OLEOPT_RENDER, OLECLIPFORMAT);
	version(LDC){}else OLESTATUS OleCreateFromFile(LPCSTR, LPOLECLIENT, LPCSTR, LPCSTR,
	...
	version(LDC){}else OLESTATUS OleLoadFromStream(LPOLESTREAM, LPCSTR, LPOLECLIENT, LHCLIENTDOC,
	  LPCSTR, LPOLEOBJECT*);
	version(LDC){}else OLESTATUS OleCreate(LPCSTR, LPOLECLIENT, LPCSTR, LHCLIENTDOC, LPCSTR,
	  LPOLEOBJECT*, OLEOPT_RENDER, OLECLIPFORMAT);
